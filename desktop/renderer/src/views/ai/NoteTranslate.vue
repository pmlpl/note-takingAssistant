...
@media (min-width: 992px) {
  ...
  .hub-line {
    ...
    width: calc(50% - 108px);
    margin-top: -1px;
    background: linear-gradient(90deg, var(--color-muted), rgba(74, 127, 196, 0.5));
    pointer-events: none;
  }

  .hub-line--left {
    left: 0;
    background: linear-gradient(90deg, transparent, rgba(74, 127, 196, 0.5));
  }

  .hub-line--right {
    right: 0;
    background: linear-gradient(270deg, transparent, rgba(74, 127, 196, 0.5));
  }
}
