...
.stat-notes:hover {
  background: linear-gradient(135deg, color-mix(in srgb, var(--color-blue) 12%, var(--color-card-bg)) 0%, var(--color-card-bg) 100%);
}

.stat-ai:hover {
  background: linear-gradient(135deg, color-mix(in srgb, var(--color-green) 15%, var(--color-card-bg)) 0%, var(--color-card-bg) 100%);
}

.stat-active:hover {
  background: linear-gradient(135deg, color-mix(in srgb, var(--color-orange) 15%, var(--color-card-bg)) 0%, var(--color-card-bg) 100%);
}
